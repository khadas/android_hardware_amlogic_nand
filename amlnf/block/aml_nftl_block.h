...
struct aml_nftl_dev{
    ...
    uint32 (*discard_data)(struct aml_nftl_dev *nftl_dev, unsigned long block, uint32 nblk);
...
struct aml_nftl_blk{
    ...
    uint32 (*discard_data)(struct aml_nftl_blk *nftl_blk, unsigned long block, uint32 nblk);
